...
### Local Development
To use `gdal-lambda`, you need to have Node.js installed on your system. The Node version should be ^20.0.0.
...
```123456789012.dkr.ecr.us-east-1.amazonaws.com/{namespace}/gdal-lambda:latest```
...
```aws push 123456789012.dkr.ecr.us-east-1.amazonaws.com/{namespace}/gdal-lambda:latest```
...
```aws lambda create-function --function-name gdal-lambda --package-type Image --code ImageUri=123456789012.dkr.ecr.us-east-1.amazonaws.com/{namespace}/gdal-lambda:latest --role arn:aws:iam::123456789012:role/lambda-ex --timeout 15 --memory-size 1024```
